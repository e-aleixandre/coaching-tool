 ...
 * Client note routes
 */
Route::get('clients/{client}/notes/{note}/edit', [NoteController::class, 'edit'])->middleware('auth')->name('notes.edit');
Route::put('clients/{client}/notes/{note}', [NoteController::class, 'update'])->middleware('auth')->name('notes.update');
